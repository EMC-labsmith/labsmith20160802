...
urlpatterns = [
    ...
    url(r'^IPResult/$',views.IPResult, name = "IPResult"),
    url(r'^mainLog/delete/$', views.delete, name="delete"),
    url(r'^reserveNumber/$', views.reserve_slicsfp, name="reserve_slicsfp"),
    url(r'^releaseNumber/$', views.release_slicsfp, name="release_slicsfp"),
    url(r'^RackLayout/$',views.RackLayout, name = "RackLayout"),
    url(r'^pxeGuide/$',views.pxeGuide, name = "pxeGuide"),
]
